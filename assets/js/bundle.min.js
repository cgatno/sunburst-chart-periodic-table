...
m.beginUpdate(),m.legend.position="None",m.innerRadius=0.3,m.selectionMode="Point",m.dataLabel.position="Center",m.dataLabel.content="{name}",m.itemsSource=h,m.binding="value",m.bindingName=["groupName","subGroupName","eleSymbol"],m.childItemsPath=["subGroups","elements"],m.hostElement.addEventListener("click",function(x){j(x.clientX,x.clientY);// Perform a hit test to get a clicked panel's name then use it to set up the info panel via the ViewAdapter
...
m.endUpdate()})},{"./lib/data/DAL/DataSourceAdapter":2,"./lib/view/PropertiesTile":7,"./lib/view/ViewAdapter":8,"./shim.js":9}],2:[function(b,c){"use strict";/**
...
return d(p,k)},c.exports=new j},{"../data/model/Element":3,"../data/model/Group":4,"../data/model/SubGroup":5}],9:[function(){"use strict";// Polyfill for Array.find
Array.prototype.find||Object.defineProperty(Array.prototype,"find",{value:function(b){if(null==this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof b)throw new TypeError("predicate must be a function");var c=Object(this),d=c.length>>>0,g=arguments[1],h;for(var j=0;j<d;j++)if(h=c[j],b.call(g,h,j,c))return h;return void 0}})},{}]},{},[1]);
